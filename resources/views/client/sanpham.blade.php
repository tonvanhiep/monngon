        ...
        <div class="banner-wrapper">
          <div class="container">
            <div class="content-banner">
              <h1 class="title-banner">Danh sách sản phẩm</h1>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="item-product">
                            <a href="/detail-blog.html">
                                <div class="img-wrapper">
                                    <img src="images/products/hinh-1.jpg" alt="Product" />
                                </div>
                            </a>
                            <div class="info-product">
                                <a href="/detail-blog.html"><div class="name">Gỏi cuốn</div></a>
                    ...
                    <div class="col-4">
                        <div class="item-product">
                            <a href="/detail-blog.html">
                                <div class="img-wrapper">
                                    <img src="images/products/hinh-2.jpg" alt="Product" />
                                </div>
                            </a>
                            <div class="info-product">
                                <a href="/detail-blog.html"><div class="name">Bánh tráng trộn</div></a>
                    ...
                    <div class="col-4">
                        <div class="item-product">
                            <a href="/detail-blog.html">
                                <div class="img-wrapper">
                                    <img src="images/products/hinh-3.jpg" alt="Product" />
                                </div>
                            </a>
                            <div class="info-product">
                                <a href="/detail-blog.html"><div class="name">Bún đậu mắm tôm</div></a>
                    ...
                    <div class="col-4">
                        <div class="item-product">
                            <a href="/detail-blog.html">
                                <div class="img-wrapper">
                                    <img src="images/products/hinh-4.jpg" alt="Product" />
                                </div>
                            </a>
                            <div class="info-product">
                                <a href="/detail-blog.html"><div class="name">Bánh mì</div></a>
                    ...
                    <div class="col-4">
                        <div class="item-product">
                            <a href="/detail-blog.html">
                                <div class="img-wrapper">
                                    <img src="images/products/hinh-5.jpg" alt="Product" />
                                </div>
                            </a>
                            <div class="info-product">
                                <a href="/detail-blog.html"><div class="name">Bánh bột lọc</div></a>
                    ...
                    <div class="col-4">
                        <div class="item-product">
                            <a href="/detail-blog.html">
                                <div class="img-wrapper">
                                    <img src="images/products/hinh-6.jpg" alt="Product" />
                                </div>
                            </a>
                            <div class="info-product">
                                <a href="/detail-blog.html"><div class="name">Sushi/Sashimi</div></a>
